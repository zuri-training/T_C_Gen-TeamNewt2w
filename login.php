	...
	<div class="phppot-container">
		<div class="sign-up-container">
			...
			<div class="signup-align">
					<div class="signup-heading" style="color:black;">Welcome Back</div>
			<form name="login" action="" method="post" onsubmit="return loginValidation()">
				<div class="signup-heading" style="color:black;">Login Using</div>
				<div><img src="./assets/img/Group 6.png">
						<img src="./assets/img/Group 7.png">
						<img src="./assets/img/Group 8.png"></div>
